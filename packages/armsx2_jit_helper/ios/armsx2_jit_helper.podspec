Pod::Spec.new do |s|
  s.name             = 'armsx2_jit_helper'
  s.version          = '0.1.0'
  s.summary          = 'Out-of-process StikJIT universal helper for NeoStation ARMSX2.'
  s.description      = <<-DESC
App-extension implementation used only by NeoStation's embedded PlayStation 2
engine. It attaches StikJIT to the NeoStation host PID and never launches an
external ARMSX2 application.
                       DESC
  ...
  s.swift_version = '5.0'
  s.module_name = 'armsx2_jit_helper'
