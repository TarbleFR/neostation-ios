...
void NeoDusklight_ReleaseThreadRecords(void);
void NeoDusklight_ReleaseMutexRecords(void);
void NeoDusklight_ReleaseMessageQueueRecords(void);
int NeoDusklight_ReleaseARAM(void);
int NeoDusklight_ReleaseMEM1(void);
const char* NeoDusklight_LastShutdownReport(void);
