...
// NeoStation adaptation: embedded SDL resources belong to DusklightCore.framework.
...
{
    const char *resources = NeoDusklight_ResourcesPath();
    return resources && *resources ? SDL_strdup(resources) : NULL;
}
