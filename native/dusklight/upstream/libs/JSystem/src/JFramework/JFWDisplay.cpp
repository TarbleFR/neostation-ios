...
#if TARGET_PC && NEO_DUSKLIGHT_EMBEDDED
    // NeoStation's display link already paces frames. Sleeping a second time
    // here would block UIKit and miss the next 30 Hz display-link deadline.
    return;
#endif
#if TARGET_PC
