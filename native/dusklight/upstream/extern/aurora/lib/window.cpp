...
// NeoStation: use the invoking host scene, never select another app scene.
#include "window.hpp"
...
bool create_window(AuroraBackend backend) {
  ...
  SDL_SetPointerProperty(props, SDL_PROP_WINDOW_CREATE_WINDOWSCENE_POINTER, NeoDusklight_WindowScene());
