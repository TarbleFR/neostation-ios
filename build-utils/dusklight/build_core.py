...
def package(source, framework, destination):
    ...
    identity = {
        ...
        "session_policy": "host_frame_loop_warm_resume_rpcs3_jit_escrow",
    }
    ...
    print(f"Validated arm64 framework, private SDL classes, ABI v7 and {len(identity['resources'])} resources.")
