...
def package(source, framework, destination):
    ...
    identity = {
        ...
        "session_policy": "host_frame_loop_terminal_address_space_release",
    }
    ...
    print(f"Validated arm64 framework, private SDL classes, ABI v5 and {len(identity['resources'])} resources.")
