...
# Build the Build 303 recovery RPCS3Core only.
# Intentional policy: keep the validated Build 266 adaptive/Core-owned JIT allocator,
# add Build 301 passive dlopen, and do NOT apply Build 295/302 fixed host reservation.
...
log "Apply Build 266 adaptive JIT + Build 301 passive dlopen recovery stack (Build 295/302 omitted)"
