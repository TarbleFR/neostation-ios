...
const Map<String, dynamic> appLocaleEs = {
  ...
  AppLocale.cloudSaveSubtitle: 'Desde iCloud Saves',
  ...
  AppLocale.cloudSavesLocalSavesOnly: 'iCloud Saves: Solo partidas locales',
  AppLocale.cloudSavesCloudSavesOnly: 'iCloud Saves: Solo partidas en la nube',
  AppLocale.cloudSavesSaveConflict: 'iCloud Saves: Conflicto de guardado detectado',
  AppLocale.cloudSavesCloudSyncDisabled: 'iCloud Saves: Sincronización desactivada',
  AppLocale.cloudSavesQuotaExceeded: 'iCloud Saves: Cuota de almacenamiento superada',
