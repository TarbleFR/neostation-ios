...
const Map<String, dynamic> appLocaleZhHant = {
  ...
  AppLocale.cloudSaveSubtitle: '來自 iCloud Saves',
  ...
  AppLocale.cloudSavesLocalSavesOnly: 'iCloud Saves: 僅本機存檔',
  AppLocale.cloudSavesCloudSavesOnly: 'iCloud Saves: 僅雲端存檔',
  AppLocale.cloudSavesSaveConflict: 'iCloud Saves: 偵測到存檔衝突',
  AppLocale.cloudSavesCloudSyncDisabled: 'iCloud Saves: 雲端同步已停用',
  AppLocale.cloudSavesQuotaExceeded: 'iCloud Saves: 儲存空間已滿',
