...
const Map<String, dynamic> appLocalePt = {
  ...
  AppLocale.cloudSaveSubtitle: 'Do iCloud Saves',
  ...
  AppLocale.cloudSavesLocalSavesOnly: 'iCloud Saves: Apenas saves locais',
  AppLocale.cloudSavesCloudSavesOnly: 'iCloud Saves: Apenas saves na nuvem',
  AppLocale.cloudSavesSaveConflict: 'iCloud Saves: Conflito de save detectado',
  AppLocale.cloudSavesCloudSyncDisabled:
      'iCloud Saves: Sincronização em nuvem desativada',
  AppLocale.cloudSavesQuotaExceeded: 'iCloud Saves: Cota de armazenamento excedida',
