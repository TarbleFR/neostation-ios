...
const Map<String, dynamic> appLocaleEn = {
  ...
  AppLocale.cloudSaveSubtitle: 'From iCloud Saves',
  ...
  AppLocale.cloudSavesLocalSavesOnly: 'iCloud Saves: Local saves only',
  AppLocale.cloudSavesCloudSavesOnly: 'iCloud Saves: Cloud saves only',
  AppLocale.cloudSavesSaveConflict: 'iCloud Saves: Save conflict detected',
  AppLocale.cloudSavesCloudSyncDisabled: 'iCloud Saves: Cloud sync disabled',
  AppLocale.cloudSavesQuotaExceeded: 'iCloud Saves: Storage quota exceeded',
