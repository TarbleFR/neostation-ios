...
const Map<String, dynamic> appLocaleRu = {
  ...
  AppLocale.cloudSaveSubtitle: 'Из iCloud Saves',
  ...
  AppLocale.cloudSavesLocalSavesOnly: 'iCloud Saves: Только локальные сохранения',
  AppLocale.cloudSavesCloudSavesOnly: 'iCloud Saves: Только облачные сохранения',
  AppLocale.cloudSavesSaveConflict: 'iCloud Saves: Конфликт сохранений',
  AppLocale.cloudSavesCloudSyncDisabled:
      'iCloud Saves: Облачная синхронизация выключена',
  AppLocale.cloudSavesQuotaExceeded: 'iCloud Saves: Превышена квота хранилища',
