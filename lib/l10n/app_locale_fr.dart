...
const Map<String, dynamic> appLocaleFr = {
  ...
  AppLocale.libraryAddons: 'Répertoire',
  ...
  AppLocale.libraryAddonUrlHelp:
      'URL HTTPS d’un manifeste NeoStation ou d’un dépôt Tachiyomi/Mihon.',
  ...
  AppLocale.cloudSaveSubtitle: 'Depuis iCloud Saves',
  ...
  AppLocale.cloudSavesLocalSavesOnly: 'iCloud Saves : Sauvegardes locales uniquement',
  AppLocale.cloudSavesCloudSavesOnly: 'iCloud Saves : Sauvegardes cloud uniquement',
  AppLocale.cloudSavesSaveConflict: 'iCloud Saves : Conflit de sauvegarde détecté',
  AppLocale.cloudSavesCloudSyncDisabled:
      'iCloud Saves : Synchronisation cloud désactivée',
  AppLocale.cloudSavesQuotaExceeded: 'iCloud Saves : Quota de stockage dépassé',
